use crate::ui::command::parser::{
    ...
    BREAK_COMMAND_SHORT, CONTINUE_COMMAND, CONTINUE_COMMAND_SHORT, DISASM_COMMAND, FRAME_COMMAND,
    ...
    SHARED_LIB_COMMAND_INFO_SUBCOMMAND, STEP_INSTRUCTION_COMMAND, STEP_INTO_COMMAND,
