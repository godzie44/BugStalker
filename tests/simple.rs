...
fn test_multiple_breakpoint_set() {
    ...
    session.exp_string("No previous history.").unwrap();
    session.send_line("break 55555555BBE0").unwrap();
    session.exp_string("break 55555555BBE0").unwrap();
    session.send_line("break 55555555BC13").unwrap();
    session.exp_string("break 55555555BC13").unwrap();
    ...
    session
        .exp_string("Hit breakpoint at address 0x55555555BBE0")
        .unwrap();
...
fn test_read_write_register() {
    ...
    session.send_line("break 55555555BC1C").unwrap();
    session.exp_string("break 55555555BC1C").unwrap();
