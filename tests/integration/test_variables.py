...
class VariablesTestCase(unittest.TestCase):
    ...
    def test_address(self):
        ...
        self.debugger.sendline('var &int8')
        self.debugger.expect(r'&i8 \[0x[0-9A-F]{14}\]')
        self.debugger.sendline('var *&int8')
        self.debugger.expect_exact('i8(1)')
        ...
        self.debugger.sendline('var &tuple_1')
        self.debugger.expect(r'&\(f64, f64\) \[0x[0-9A-F]{14}\]')
        self.debugger.sendline('var *&tuple_1')
        self.debugger.expect_exact('(f64, f64) {')
        self.debugger.expect_exact('0: f64(0)')
        self.debugger.expect_exact('1: f64(1.1)')
        self.debugger.expect_exact('}')
        self.debugger.sendline('var &tuple_1.0')
        self.debugger.expect(r'&f64 \[0x[0-9A-F]{14}\]')
        self.debugger.sendline('var *&tuple_1.0')
        self.debugger.expect_exact('f64(0)')
        self.debugger.sendline('var &foo2.foo.bar')
        self.debugger.expect(r'&i32 \[0x[0-9A-F]{14}\]')
        self.debugger.sendline('var *&foo2.foo.bar')
        self.debugger.expect_exact('i32(100)')
        ...
        self.debugger.expect(r'&\[i32\] \[0x[0-9A-F]{14}\]')
        self.debugger.sendline('var *&arr_1')
        self.debugger.expect_exact('[i32] {')
        self.debugger.expect_exact('0: i32(1)')
        self.debugger.expect_exact('1: i32(-1)')
        self.debugger.sendline('var &arr_1[3]')
        self.debugger.expect(r'&i32 \[0x[0-9A-F]{14}\]')
        ...
        self.debugger.sendline('var &GLOB_1')
        self.debugger.expect(r'&&str \[0x[0-9A-F]{14}\]')
        self.debugger.sendline('var *&GLOB_1')
        self.debugger.expect_exact('&str(glob_1)')
        ...
        self.debugger.sendline('var &hm6[{field_1: 1, field_2: *, field_3: *}]')
        self.debugger.expect(r'&i32 \[0x[0-9A-F]{14}\]')
        self.debugger.sendline('var *&hm6[{field_1: 1, field_2: *, field_3: *}]')
        self.debugger.expect_exact('i32(1)')
