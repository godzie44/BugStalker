...
class SignalsTestCase(unittest.TestCase):
    def test_signal_stop_single_thread(self):
        ...
        self.debugger = pexpect.spawn(
            './target/debug/bs -t none ./examples/target/debug/signals -- single_thread')
    ...
    def test_multi_thread_signal(self):
        ...
        self.debugger = pexpect.spawn(
            './target/debug/bs -t none ./examples/target/debug/signals -- multi_thread')
        self.debugger.expect('BugStalker greets')
    ...
    def test_multi_thread_multi_signal(self):
        ...
        self.debugger = pexpect.spawn(
            './target/debug/bs -t none ./examples/target/debug/signals -- multi_thread_multi_signal')
        self.debugger.expect('BugStalker greets')
    ...
    def test_transparent_signal(self):
        ...
        self.debugger = pexpect.spawn(
            './target/debug/bs -t none ./examples/target/debug/sleeper -- -s 5')
        self.debugger.expect('BugStalker greets')
